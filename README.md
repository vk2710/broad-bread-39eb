...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/broad-bread-39eb#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/broad-bread-39eb
```

A live public deployment of this template is available at [https://broad-bread-39eb.templates.workers.dev](https://broad-bread-39eb.templates.workers.dev)
